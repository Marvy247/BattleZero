import { Client as ZkBattleshipClient, type Game } from './bindings';
...
/**
 * Service for interacting with the ZkBattleship game contract
 */
export class ZkBattleshipService {
  ...
  private createSigningClient(
    ...
    return new ZkBattleshipClient(options);
  }
...
// Example: const zkBattleshipService = new ZkBattleshipService(contractId);
